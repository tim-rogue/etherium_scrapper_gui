...
#         # Create 2 buttons
#         self.button_left = Tkinter.Button(self.frame,text="Plot SMAs",
#                                         command=lambda: self.plotSMAs([10,50,100]))
...
#         self.xdate = [datetime.datetime.fromtimestamp(i) for i in self.ethbot.historicalData['date'].values]
#         self.lines = []
#         self.line, = self.ax.plot(self.ethbot.historicalData['close'],'0.6')
#         self.lines.append(mlines.Line2D([], [], color='0.6', markersize=15, label='close'))
#         self.ax.legend(handles=self.lines,loc=0)    
#         #self.ax.ylabel('Price')
#         self.ax.grid(True)
#         self.ax.xaxis.set_major_locator(ticker.MaxNLocator(7))
#         self.ax.xaxis.set_major_formatter(ticker.FuncFormatter(self.mydate))
...
#         self.frame.pack()
# 
#     def plotSMAs(self,windows):
#         colours = ['firebrick','lightseagreen','darkturquoise','gold','coral','r','g','b']
#         smas = self.ethbot.getSMAs(windows)
#         names = smas.columns.values.tolist()
#         
#         for i in range(len(names)):
#             
#                 self.ax.plot(smas[names[i]],colours[i])
#                 self.lines.append(mlines.Line2D([], [], color=colours[i], markersize=15, label=smas[names[i]].name))
#         
#         self.ax.legend(handles=self.lines,loc=0)
#         self.canvas.draw()
# 
